		...
		<div className="text-black">
			<main>
				...
				<div className='h-96 hidden lg:flex w-fullpl-4'>
					...
					<div className='w-1/2 lg:flex lg:items-center'>
				...
				<div className='h-96 lg:hidden w-full flex flex-col '>
					<div className='w-full  h-full flex flex-col md:gap-y-4'>
						<h1 className=" text-xl text-center order-2 md:order-1 mt-5 mb-5 font-bold">Recuerda que puedes pagar tu servicio eléctrico de tu medidor</h1>
						<div className='w-full md:h-1/2 order-1 md:order-2 '>
							<Image src={'/corpoImagenes/medidor.jpg'} className='md:h-[300px] md:w-full' width={700} height={450} alt='imagen no disponible' />
						</div>
					</div>
					<button className='block w-full rounded-md border border-transparent bg-azulPantone px-8 py-3 text-base font-medium text-white bg-opacity-80 hover:bg-opacity-100 sm:w-auto'>
						¡Aquí!
				...
				<div className='h-96 w-full mt-10 relative'>
					...
					<div aria-hidden="true" className="absolute w-full inset-0 flex flex-col items-center justify-center">
						<div className="w-full px-5 lg:px-0 lg:w-1/2 flex flex-col items-center gap-4">
							...
							<button onClick={() => router.push('/productos/LED')} className="block w-full rounded-3xl border border-transparent bg-azulPantone px-8 py-3 text-base font-medium text-white bg-opacity-80 hover:bg-opacity-100 sm:w-auto">
						...
						<div className=" relative bg-gray-900 bg-opacity-75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
							<div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
								<h2 id="social-impact-heading" className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
									<span className="block sm:inline">Conoce más acerca de nosotros, nuestra Misión y Visión</span>
								</h2>
								<button
