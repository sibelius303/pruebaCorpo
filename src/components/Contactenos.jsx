...
const Contactenos = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-8">
            <h1 className="mb-4 text-xl font-bold">{mensaje}</h1>
            <div className="flex gap-4">
                ...
                <button
                    className=" font-bold py-2 px-4 rounded flex items-center justify-center"
                >
                    <svg className="transform hover:scale-150 transition-transform" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
