    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex gap-4">
                ...
                >
                    <svg className="transform hover:scale-125 transition-transform" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
                ...
                <button
                    className=" font-bold py-2 px-4 rounded flex items-center justify-center"
                >
                    <svg className="transform hover:scale-125 transition-transform" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
