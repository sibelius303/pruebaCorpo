...
export default function ItemProduct({ product }) {
    ...
    return <Link href={`/productos/${product.id}`} className="group bg-white rounded-xl shadow hover:shadow-2xl flex md:block cursor-pointer h-fit">
        ...
        <div className="flex flex-col justify-between px-3 pb-4 h-auto md:h-[25vh]">
            ...
            <span className="border-t border-gray-400 mt-2 py-2 flex justify-center w-full text-sm text-blue-400 hover:text-blue-500 hover:bg-blue-100 rounded-md">Ver</span>
        </div>
    </Link>
}