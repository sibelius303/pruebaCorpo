	...
	return (
		<div className=" h-auto pt-10">
			<div style={{ backgroundColor: '#172168' }} className='h-96 w-full mt-10 relative '>
				...
				<div onClick={() => setProduct(3)} style={{ backgroundColor: '#65BCE0' }} className='absolute h-80 w-64 top-24 right-96 rounded-lg miDiv3 hover:miDivHover3'>
					<div className='h-1/2 w-full'>
				...
				<div onClick={() => setProduct(2)} style={{ backgroundColor: '#65BCE0' }} className='absolute h-80 w-64 top-24 right-10 rounded-lg'>
					<div className='h-1/2 w-full'>

					</div>
					<div className='h-1/2 w-full text-white flex flex-col gap-5 justify-end p-5'>
						<h1 className='text-2xl font-bold'>Energia Renovable</h1>
						<p>Descubre mas</p>
					</div>
				</div>
			</div>
					...
					product === 0 && <div className="w-full">
						...
						<div className='w-full flex'>
							...
							<div className="w-1/2 py-10 flex flex-col items-center justify-center">
								<div className='flex'>
									<Image src={'/corpoImagenes/luminariapublica.jpg'}
										width={300}
										height={300}
						...
						<div className='w-full flex'>
							...
							<div className="w-1/2 py-10 flex flex-col items-center justify-center">
								<div className='flex h-[300px]'>
									<Image src={'/corpoImagenes/luzledsolar250frontal.jpeg'}
										width={300}
										height={200}
										className='rounded-md'
										alt='imagen no disponible'
									/>
									<Image src={'/corpoImagenes/luzledsolar250detras.jpeg'}
										width={300}
										height={200}
										className='rounded-md'
										alt='imagen no disponible'
						...
						<div className='w-full flex'>
							<div className="w-1/2 py-10 flex flex-col items-center justify-center">
								<div className='flex h-[300px]'>
									<Image src={'/corpoImagenes/luzledredonda.jpeg'}
										width={300}
										height={200}
										className='rounded-md'
										alt='imagen no disponible'
									/>
									<Image src={'/corpoImagenes/luzledredondaatras.jpeg'}
										width={300}
										height={200}
										className='rounded-md'
										alt='imagen no disponible'
